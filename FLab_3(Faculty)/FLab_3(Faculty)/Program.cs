...
namespace LabTask_Faculty
{
    public class Faculty //abstract
    {
        private string name;
        private string id;
    ...
    public class Varsity // : CS_Dept
    {
        ...
        public Varsity(string name, string address, CS_Dept csdept)
        {
            this.name = name;
            this.address = address;
            this.csdept = csdept;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Varsity v = new Varsity("varsity", "kuratoli", cd);
            v.PrintVarsityInfo();
            v.PrintCSDeptInfo();
